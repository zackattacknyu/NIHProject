...
\item Correlate values from (4) in the temperature zones with the temperature data
\item Use regression from (5) to generate thermal map for entire ROI
\end{enumerate}
...
%-------------
   ...
   \begin{center}
   \begin{tabular}{c}
   \includegraphics[height=7cm]{meanTempVsRadiusFull.png}
   \end{tabular}
   \end{center}
   \caption[example] 

function [ diffVals,tempVals ] = getDiffTempVals( controlIndImage,ablationIndImage,...
    diffValsImage,diffVals2Image,wSize,temps )
...
diffValsAblation = diffValsImage(ablationInds);
diffValsControl = diffValsImage(controlInds);
diffValsAblation2 = diffVals2Image(ablationInds);
diffValsControl2 = diffVals2Image(controlInds);

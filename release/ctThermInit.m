function varargout = ctThermInit(varargin)
...
baselineScan = evalin('base','baselineScan');
assignin('base','currentBaseROI',getBlockInVolume(baselineScan,minCoords,maxCoords));
try
    comparisonScan = evalin('base','comparisonScan');
    assignin('base','currentComparisonROI',getBlockInVolume(comparisonScan,minCoords,maxCoords));
catch 
end
